...
export function Review({ products }) {
  return (
    <div>
      {products ? (
        products.map((product) => {
          const topReviews = product.reviews.edges;
                ...
                <ul>
                  {topReviews.map((review) => (
                    <li key={review.node.id}>
                      ...
                      <p>Author: {review.node.author.name}</p>
        ...
        <p className="text-center text-lg h-screen">No reviews yet!</p>
      )}
    </div>

    // <div className=" px-4 md:px-6 my-5 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center">
    ...
    //           dataflickity='{ "wrapAround": true,"pageDots": false }'
    //         >
